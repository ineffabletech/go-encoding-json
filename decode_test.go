...
var unmarshalTests = []unmarshalTest{
	...
	{in: `{"X": [1,2,3], "Y": 4}`, ptr: new(T), out: T{Y: 4}, err: &UnmarshalTypeError{"X", "array", reflect.TypeOf(""), 7, "T", "X"}},
	{in: `{"x": 1}`, ptr: new(tx), out: tx{}},
	{in: `{"x": 1}`, ptr: new(tx), err: &UnmarshalUnknownKeyError{"x", 1}, disallowUnknownFields: true},
	...
	{in: `{"Y": 1, "Z": 2}`, ptr: new(T), err: &UnmarshalUnknownKeyError{"Z", 9}, disallowUnknownFields: true},

	{in: `{"alpha": "abc", "alphabet": "xyz"}`, ptr: new(U), out: U{Alphabet: "abc"}},
	{in: `{"alpha": "abc", "alphabet": "xyz"}`, ptr: new(U), err: &UnmarshalUnknownKeyError{"alphabet", 17}, disallowUnknownFields: true},
	{in: `{"alpha": "abc"}`, ptr: new(U), out: U{Alphabet: "abc"}},
	{in: `{"alphabet": "xyz"}`, ptr: new(U), out: U{}},
	{in: `{"alphabet": "xyz"}`, ptr: new(U), err: &UnmarshalUnknownKeyError{"alphabet", 1}, disallowUnknownFields: true},
	...
	},
	{
		in:  `{"X": 1,"Y":2}`,
		ptr: new(S5),
		err: &UnmarshalUnknownKeyError{"X", 1},
	...
	// additional tests for disallowUnknownFields
	{
		...
		ptr: new(Top),
		err: &UnmarshalUnknownKeyError{"extra", 282},
		disallowUnknownFields: true,
	},
	{
		in: `{
		...
		ptr: new(Top),
		err: &UnmarshalUnknownKeyError{"extra", 198},
		disallowUnknownFields: true,
	},
}
